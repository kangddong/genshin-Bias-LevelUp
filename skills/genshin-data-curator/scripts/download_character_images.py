...
def main() -> int:
    data_path = Path("Resources/Data/characters.json")
    output_dir = Path("Resources/Images/characters")
    ...
    for item in characters:
        ...
        for candidate in candidates:
            downloaded = download(candidate, timeout=12, ctx=ctx)
            if downloaded:
                break
        ...
        item["localImage"] = f"Images/characters/{file_name}"
        success += 1
